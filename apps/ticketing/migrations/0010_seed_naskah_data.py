...
def seed_naskah_and_seasons(apps, schema_editor):
    ...
    for item in naskah_data:
        script, _ = ShowScript.objects.update_or_create(
            title=item['title'],
            defaults={
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ticketing', '0009_showscript_tickettype_show_time_and_more'),
    ]

    operations = [
        migrations.RunPython(seed_naskah_and_seasons, reverse_code=migrations.RunPython.noop),
    ]
